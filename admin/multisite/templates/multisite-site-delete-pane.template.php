<div id="ee-delete-progress-pane" style="display:none">
    <h2 id="sites-migrated-progress-bar-header"><?php _e('Sites Deleted', 'event_espresso'); ?></h2>
    <div id="sites-deleted-progress-bar" class="progress-bar">
        <figure>
