            ...
            [
                ...
                'subsections'     => [
                    'header'        => new EE_Form_Section_HTML(
                        EEH_HTML::h1(__('Multisite Queryer', 'event_espresso'))
                    ),
                    ...
                    'explanation'   => new EE_Form_Section_HTML(
                        EEH_HTML::p(
                            __(
                                'Will execute a query on every site in the network and generate a CSV file of the results',
                                'event_espresso'
                            )
                        )
                    ),
                    ...
                    'stop_on_error' => new EE_Yes_No_Input(
                        [
                            'html_help_text' => __(
                                'Whether to stop everything on exception, or just skip',
                                'event_espresso'
                            ),
                        ]
                    ),
